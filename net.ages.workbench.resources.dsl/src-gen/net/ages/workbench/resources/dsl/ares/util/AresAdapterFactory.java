/**
 */
package net.ages.workbench.resources.dsl.ares.util;
...
public class AresAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected AresSwitch<Adapter> modelSwitch =
    ...
    {
      @Override
      public Adapter caseAresModel(AresModel object)
      {
        return createAresModelAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.ages.workbench.resources.dsl.ares.AresModel <em>Model</em>}'.
   * <!-- begin-user-doc -->
   ...
   * @generated
   */
  public Adapter createAresModelAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link net.ages.workbench.resources.dsl.ares.Definition <em>Definition</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
