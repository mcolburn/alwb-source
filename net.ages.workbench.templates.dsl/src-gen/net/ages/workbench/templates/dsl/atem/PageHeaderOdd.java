...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Page Header Odd</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link net.ages.workbench.templates.dsl.atem.PageHeaderOdd#getDsl_PageHeader_columns <em>Dsl Page Header columns</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.ages.workbench.templates.dsl.atem.AtemPackage#getPageHeaderOdd()
 * @model
 * @generated
 */
public interface PageHeaderOdd extends HeadComponent
{
  /**
   ...
   * @see net.ages.workbench.templates.dsl.atem.AtemPackage#getPageHeaderOdd_Dsl_PageHeader_columns()
