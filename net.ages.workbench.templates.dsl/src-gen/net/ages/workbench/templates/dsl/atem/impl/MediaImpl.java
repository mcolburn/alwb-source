 ...
 * <ul>
 *   <li>{@link net.ages.workbench.templates.dsl.atem.impl.MediaImpl#getDsl_Elements <em>Dsl Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MediaImpl extends AbstractComponentImpl implements Media
{
  /**
  ...
  {
    return AtemPackage.Literals.MEDIA;
  }
  ...
  public EList<ElementType> getDsl_Elements()
  {
    ...
    {
      dsl_Elements = new EObjectContainmentEList<ElementType>(ElementType.class, this, AtemPackage.MEDIA__DSL_ELEMENTS);
    }
    return dsl_Elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AtemPackage.MEDIA__DSL_ELEMENTS:
