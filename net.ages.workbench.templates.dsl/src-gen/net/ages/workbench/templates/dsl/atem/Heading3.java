 ...
 * <ul>
 *   <li>{@link net.ages.workbench.templates.dsl.atem.Heading3#getDsl_Elements <em>Dsl Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.ages.workbench.templates.dsl.atem.AtemPackage#getHeading3()
 * @model
 * @generated
 */
public interface Heading3 extends AbstractComponent, SectionElementType
{
  /**
   ...
   * @see net.ages.workbench.templates.dsl.atem.AtemPackage#getHeading3_Dsl_Elements()
