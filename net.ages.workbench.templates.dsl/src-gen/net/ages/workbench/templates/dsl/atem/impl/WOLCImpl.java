...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>WOLC</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.ages.workbench.templates.dsl.atem.impl.WOLCImpl#isDsl_Display_DayLukan <em>Dsl Display Day Lukan</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class WOLCImpl extends LdpTypeImpl implements WOLC
{
  /**
  ...
  {
    return AtemPackage.Literals.WOLC;
  }
  ...
  public void setDsl_Display_DayLukan(boolean newDsl_Display_DayLukan)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AtemPackage.WOLC__DSL_DISPLAY_DAY_LUKAN, oldDsl_Display_DayLukan, dsl_Display_DayLukan));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AtemPackage.WOLC__DSL_DISPLAY_DAY_LUKAN:
