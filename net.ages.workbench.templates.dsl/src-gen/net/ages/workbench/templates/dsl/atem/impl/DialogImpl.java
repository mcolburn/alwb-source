 ...
 * <ul>
 *   <li>{@link net.ages.workbench.templates.dsl.atem.impl.DialogImpl#getDsl_Elements <em>Dsl Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DialogImpl extends AbstractComponentImpl implements Dialog
{
  /**
  ...
  {
    return AtemPackage.Literals.DIALOG;
  }
  ...
  public EList<ElementType> getDsl_Elements()
  {
    ...
    {
      dsl_Elements = new EObjectContainmentEList<ElementType>(ElementType.class, this, AtemPackage.DIALOG__DSL_ELEMENTS);
    }
    return dsl_Elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AtemPackage.DIALOG__DSL_ELEMENTS:
