 ...
 * <ul>
 *   <li>{@link net.ages.workbench.templates.dsl.atem.impl.DOMImpl#isDsl_Display_Mode <em>Dsl Display Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DOMImpl extends LdpTypeImpl implements DOM
{
  /**
  ...
  {
    return AtemPackage.Literals.DOM;
  }
  ...
  public void setDsl_Display_Mode(boolean newDsl_Display_Mode)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AtemPackage.DOM__DSL_DISPLAY_MODE, oldDsl_Display_Mode, dsl_Display_Mode));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AtemPackage.DOM__DSL_DISPLAY_MODE:
