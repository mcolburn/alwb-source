 ...
 * <ul>
 *   <li>{@link net.ages.workbench.templates.dsl.atem.Actor#getDsl_Elements <em>Dsl Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.ages.workbench.templates.dsl.atem.AtemPackage#getActor()
 * @model
 * @generated
 */
public interface Actor extends AbstractComponent, SectionElementType
{
  /**
   ...
   * @see net.ages.workbench.templates.dsl.atem.AtemPackage#getActor_Dsl_Elements()
