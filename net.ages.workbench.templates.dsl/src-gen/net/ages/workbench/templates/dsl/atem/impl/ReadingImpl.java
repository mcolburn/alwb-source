 ...
 * <ul>
 *   <li>{@link net.ages.workbench.templates.dsl.atem.impl.ReadingImpl#getDsl_Elements <em>Dsl Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ReadingImpl extends AbstractComponentImpl implements Reading
{
  /**
  ...
  {
    return AtemPackage.Literals.READING;
  }
  ...
  public EList<ElementType> getDsl_Elements()
  {
    ...
    {
      dsl_Elements = new EObjectContainmentEList<ElementType>(ElementType.class, this, AtemPackage.READING__DSL_ELEMENTS);
    }
    return dsl_Elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AtemPackage.READING__DSL_ELEMENTS:
