...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Month Name</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.ages.workbench.templates.dsl.atem.AtemPackage#getMonthName()
 * @model
 * @generated
 */
public enum MonthName implements Enumerator
{
  /**
  ...
  /**
   * An array of all the '<em><b>Month Name</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final MonthName[] VALUES_ARRAY =
    new MonthName[]
    {
      JAN,
      FEB,
  ...
  /**
   * A public read-only list of all the '<em><b>Month Name</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<MonthName> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Month Name</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static MonthName get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      MonthName result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Month Name</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Month Name</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static MonthName get(int value)
  {
    switch (value)
    {
      case JAN_VALUE: return JAN;
      case FEB_VALUE: return FEB;
      case MAR_VALUE: return MAR;
      case APR_VALUE: return APR;
      case MAY_VALUE: return MAY;
      case JUN_VALUE: return JUN;
      case JUL_VALUE: return JUL;
      case AUG_VALUE: return AUG;
      case SEP_VALUE: return SEP;
   ...
   * @generated
   */
  private MonthName(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
