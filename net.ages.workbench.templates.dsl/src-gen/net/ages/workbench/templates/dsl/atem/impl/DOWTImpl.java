...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DOWT</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.ages.workbench.templates.dsl.atem.impl.DOWTImpl#isDsl_Display_Mode <em>Dsl Display Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DOWTImpl extends LdpTypeImpl implements DOWT
{
  /**
  ...
  {
    return AtemPackage.Literals.DOWT;
  }
  ...
  public void setDsl_Display_Mode(boolean newDsl_Display_Mode)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AtemPackage.DOWT__DSL_DISPLAY_MODE, oldDsl_Display_Mode, dsl_Display_Mode));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AtemPackage.DOWT__DSL_DISPLAY_MODE:
