 ...
 * <ul>
 *   <li>{@link net.ages.workbench.templates.dsl.atem.Reading#getDsl_Elements <em>Dsl Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.ages.workbench.templates.dsl.atem.AtemPackage#getReading()
 * @model
 * @generated
 */
public interface Reading extends AbstractComponent, SectionElementType
{
  /**
   ...
   * @see net.ages.workbench.templates.dsl.atem.AtemPackage#getReading_Dsl_Elements()
