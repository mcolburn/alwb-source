 ...
 * <ul>
 *   <li>{@link net.ages.workbench.templates.dsl.atem.impl.NOPImpl#isDsl_Display_Mode <em>Dsl Display Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NOPImpl extends LdpTypeImpl implements NOP
{
  /**
  ...
  {
    return AtemPackage.Literals.NOP;
  }
  ...
  public void setDsl_Display_Mode(boolean newDsl_Display_Mode)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AtemPackage.NOP__DSL_DISPLAY_MODE, oldDsl_Display_Mode, dsl_Display_Mode));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AtemPackage.NOP__DSL_DISPLAY_MODE:
