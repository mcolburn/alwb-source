 ...
 * <ul>
 *   <li>{@link net.ages.workbench.templates.dsl.atem.Dialog#getDsl_Elements <em>Dsl Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.ages.workbench.templates.dsl.atem.AtemPackage#getDialog()
 * @model
 * @generated
 */
public interface Dialog extends AbstractComponent, SectionElementType
{
  /**
   ...
   * @see net.ages.workbench.templates.dsl.atem.AtemPackage#getDialog_Dsl_Elements()
