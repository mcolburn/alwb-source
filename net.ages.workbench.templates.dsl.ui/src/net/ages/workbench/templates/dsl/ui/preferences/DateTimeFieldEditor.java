...
/**
 * A field editor for an date preference.  This is code from the Internet.
 */
public class DateTimeFieldEditor extends FieldEditor {
	 ...
	 */
	public DateTimeFieldEditor(String name, String labelText, Composite parent) {
	...
	public DateTimeFieldEditor(String name, String nameEnabled, String labelText, Composite parent) {
		this(name, nameEnabled, labelText, UNLIMITED, parent);
	}
	 ...
	 * @since 2.0
	 */
	public DateTimeFieldEditor(String name, String labelText, int width, Composite parent) {
		this(name, null, labelText, width, parent);
	}
	...
	public Date getDateValue() {
		...
		return new Date(getPreferenceStore().getLong(getPreferenceName()));
	}
	...
	// Michael Colburn notes.  Author is storing the date as a String.  It needs
	// to be converted later to a long value.  It is the time in milliseconds.
